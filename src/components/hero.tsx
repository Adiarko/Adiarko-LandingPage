...
export default function Hero() {
  return (
    <div className="w-full bg-[rgb(252,251,247)] lg:h-dvh flex justify-between ">
          ...
          <div className="text-wrap space-y-4">
            <h1 className="z-10 relative font-bold text-3xl text-center md:text-start md:text-4xl lg:text-5xl lg:leading-tight">
              ...
              <img
                ...
                className="absolute z-0 bottom-0 h-6 translate-y-1 translate-x-14 md:translate-y-2 md:-translate-x-4 md:h-7 lg:h-10"
                alt=""
              />
            </h1>
